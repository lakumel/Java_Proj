...
public class Using_Scanner {
	public static void main(String[] args) {
		...
		//   콘솔에서 인풋 값을 받아서 변수에 할당해서 사용할 수 있다.
		// 1.사용할 스캐너 선언
		...
		//3. 스캔너를 사용해서 콘솔에서 값을 받아서 변수에 할당 .
		...
		double avg = sum / 3.0;			// 평균을 출력 할때 실수로 정의  
		
		
		//4.입력 받은 값을 출력하고 합계 및 평균을 계산해서 출력
		System.out.printf("입력한 이름은 %s 이고, 국어점수는 %d 이고, 영어점수는 %d이고, 수학점수는 %d 입니다.\n", 
				name, kor, eng, math);
		System.out.printf("%s 님의 과목의 합은 %d이고, 평균은 %5.2f 입니다. ", name, sum, avg);
