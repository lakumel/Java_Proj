...
public class ConsoleOutput3 {
	public static void main(String[] args) {
		...
		//실수형 자료형 : double 
		double weigh = 70.5 ;
		double weigh2 = 50 ;			//오류 발생이 안됨 : 정수 ======> 실수 자동 변환
		...
		System.out.print("우리 아버님 이름은 " + fatherName + "이고, 우리 어머님 이름은 " + motherName + " 입니다."  
				+"\n나의 이름은 " + myName + "이고, 나이는 " + age + "살이고 몸무게는 " + weigh + " 입니다.\n");

		
		//3.printf(); : 문자열내에서 콤마뒤의 값을 불러들여서 출력
		System.out.println("===============printf() 으로 출력 ==================");
		System.out.printf("우리 아버님 이름은 %s이고, 우리 어머님 이름은 %s 입니다. \n", fatherName, motherName);
		System.out.printf("나의 이름은 %s이고, 나이는 %d살이고 몸무게는 %4.1f 입니다.", myName, age, weigh);
